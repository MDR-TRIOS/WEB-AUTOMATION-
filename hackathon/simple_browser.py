...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        scroll_area.setStyleSheet("""
            ...
            QScrollBar:vertical { background-color: #e8ecf1; width: 12px; }
            QScrollBar::handle:vertical { 
                background: linear-gradient(180deg, #2c5282 0%, #1e3a5f 100%);
                border-radius: 6px;
                min-height: 20px;
            }
            QScrollBar::handle:vertical:hover { background: linear-gradient(180deg, #3d70b2 0%, #2c5282 100%); }
        """)
        ...
        self.chat_history.setStyleSheet("""
            QTextEdit {
                ...
                padding: 10px;
                font-size: 12px;
                selection-background-color: #c3daf8;
            }
        """)
        ...
        # Navigation Bar Styling (Premium Theme)
        self.setStyleSheet("""
            ...
            QToolBar::separator { background-color: #d0d8e0; width: 2px; margin: 4px 8px; }
            QToolButton { 
                color: #1e3a5f; 
            ...
            if hasattr(tab, 'card'):
                if tid == tab_id:
                    tab.card.setStyleSheet("""
                        ...
                        QPushButton:hover {
                            background: linear-gradient(135deg, #5b9bd5 0%, #3d70b2 100%);
                            border: 3px solid #1e3a5f;
                        }
                    """)
